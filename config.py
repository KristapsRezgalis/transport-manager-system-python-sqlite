...
# table column names
ORDER_COLUMNS = ["ID", "SAP PO", "Sender", "Delivery", "Loading", "Unloading", "Pallets", "Weight", "Forwarder", "Cost","Customs","REF", "Invoice"]
...
TRANSPORT_ORDER_DB_COLUMNS = ["nr", "sap_po", "sender", "delivery", "loading", "unloading", "pallets", "weight", "forwarder", "cost", "customs","ref", "transport_invoice"]
